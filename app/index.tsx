        ...
        <View className="flex flex-col items-center justify-between w-full px-2 h-full">
            ...
            >
                <View className="flex flex-col gap-1">
                    ...
                    >
                        Stay consistent with your goals by showing up daily. Stride helps you build momentum one step at a time.
                    </Text>
                </View>
                ...
                <View className="flex flex-row w-full items-center justify-between mt-4">
                    ...
                    <View className="flex flex-row items-center justify-center gap-2">
                        <View className="w-[30px] h-[8px] bg-blue-600 rounded-full"></View>
                        <View className="w-[30px] h-[8px] bg-blue-300 rounded-full"></View>
                    </View>
